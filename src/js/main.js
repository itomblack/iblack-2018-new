(function () { 'use strict';
		...
		var home_Process = new Vue({
			...
			data: {
				title: 'Clients',
				subtitle: 'I\'ve worked with global brands and brand new startups throughout Europe and North America. Someone you’ll recognize, some you won’t. They all had interesting problems to solve.',
				clients: [
